...
public class FourColumn_ListAdapter extends ArrayAdapter<User1> {

    private LayoutInflater mInflater;
    private ArrayList<User1> users;
    private int mViewResourceId;

    public FourColumn_ListAdapter(Context context, int textViewResourceId, ArrayList<User1> users) {
